...
from akha.cli.handlers import handle_doctor, handle_payloads, handle_presets, handle_scan, handle_stats
...
def _configure_logging(verbose: bool) -> None:
    """Clamp noisy HTTP logging unless verbose mode is explicitly enabled."""
    if verbose:
        _logging.getLogger("akha").setLevel(_logging.INFO)
        return
